package com.literatura.literalurachallenge.Libreria;
import com.literatura.literalurachallenge.config.ConsumoApiGutendex;
import com.literatura.literalurachallenge.config.ConvertirDatos;
import com.literatura.literalurachallenge.models.Autor;
import com.literatura.literalurachallenge.models.Libro;
import com.literatura.literalurachallenge.models.LibrosRespuestaApi;
import com.literatura.literalurachallenge.models.records.DatosLibro;
...
public class Libreria {
    ...
    public void consumo(){
        ...
        while (opcion != 0){
            var menu = """
                    ...
                    1 - Incorporar Libro por Nombre
                    2 - Libros examinados
                    3 - Examinar libro por Nombre
                    4 - Examinar todos los Autores de libros examinados
                    5 - Examinar Autores por año
                    6 - Examinar Libros por Idioma
                    7 - Top 10 Libros mas bajados
                    8 - Examinar Autor por Nombre
    ...
    private Libro getDatosLibro(){
        System.out.println("El nombre del libro?: ");
    ...
    private void buscarLibroEnLaWeb() {
        ...
        if (libro == null){
            System.out.println("Libro no encontrado. Valor es null");
            return;
        }
    ...
    private  void BuscarAutores(){
        ...
        if (autores.isEmpty()) {
            System.out.println("No se encontraron libros en la base. \n");
        } else {
            System.out.println("Libros encontrados en la base: \n");
    ...
    private void  buscarLibrosPorIdioma(){
        System.out.println("Ingrese Idioma en el que quiere buscar los libros: \n");
        System.out.println("|  Opción - es : En español. |");
        System.out.println("|  Opción - en : En ingles.  |\n");
        ...
        if (librosPorIdioma.isEmpty()) {
            ...
            System.out.println("Libros segun idioma encontrados en la base:");
...
//        //BUSCAR AUTORES POR ANIO
        ...
        if (autoresVivos.isEmpty()) {
            System.out.println("No se encontro autores que estuvieran vivos en el año " + anioBuscado + ".");
        } else {
    ...
    private void buscarAutorPorNombre() {
        ...
        if (escritorBuscado != null) {
            ...
            System.out.println("\nEl escritor del titulo '" + escritor + "' no fue encontrado");
        }
    }
}
